...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description: [
      'Thesis: "Investigating Visual Compositionality in Vision-Language Models"',
      'Advisor: Prof. Nicola Strisciuglio',
      'Evaluated 15+ model variants (CLIP, SigLIP, DINOv1/v2/v3-7B, MERU, HyCoCLIP) across 3 geometric spaces',
      'Discovered attention collapse phenomenon in DINOv2; developed gradient-weighted attention visualization',
      'Key finding: Geodesic Decomposition (GDE) outperforms Linear Decomposition by 3-17x',
      'Achieved SOTA: SigLIP v2 at 24.2% AUC on UT-Zappos compositional zero-shot learning',
    ],
    technologies: ['PyTorch', 'CLIP', 'SigLIP', 'DINOv2', 'DINOv3-7B', 'Hyperbolic Geometry', 'HPC'],
